    ...
    protected ArrayList<Card> getByOpen(boolean open, String cat) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                int schedId = resultSet.getInt("schedule_id");
                ...
                if (serviceId != resultServiceId) {
                    ...
                    card = new Card(orgId, resultServiceId, name, category, latitude, longitude, schedules);
                    results.add(card);
                }


                sched = new Schedule(serviceId, day, openTime, closeTime, schedId);
